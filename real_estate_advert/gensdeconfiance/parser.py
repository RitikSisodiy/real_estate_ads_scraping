...
def ParseGensdeconfiance(data):
    ...
    try:
        ...
        terrain = re.findall(terrain_pattern, data.get("description")) or re.findall(
            terrain_pattern, data.get("title")
        )
        ...
        sdata = {
            ...
            "agency_details": {
                "logo": realEstateCompany.get("logoUrl")
                or sellerinfo.get("picture")
                or sellerinfo.get("face"),
